            ...
            child: Container(
              child: Row(
                children: [
                  CircleAvatar(
                    radius: 30,
                    backgroundImage: AssetImage('asset/spotify/samsmith.jpeg'),
                  ),
                  SizedBox(
                    width: 16,
                  ),
                ...
                child: Row(
                  children: [
                    ClipRRect(
                        ...
                        child: Image.asset('asset/spotify/loseyou.jpeg')),
                    SizedBox(
                      width: 16,
                    ),
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('Lose You (Felix Jaehn Remix)',
                                style: TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.bold,
                                    color: Colors.white)),
                            ...
                            Text('Single ∙ Sam Smith, Felix Jaehn',
